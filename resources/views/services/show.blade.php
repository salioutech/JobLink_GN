        ...
        <div style="display:flex;flex-direction:column;gap:20px;">
            ...
            <div style="background:#fff;border-radius:12px;border:1px solid #E2E8F0;padding:20px;">
                <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:16px;">
                    ...
                    @else
                        <button onclick="afficherAlerte()" style="display:flex;align-items:center;gap:6px;padding:9px 16px;border-radius:8px;border:1.5px solid #E2E8F0;background:#fff;color:#5a6a7a;cursor:pointer;font-size:13px;font-weight:600;">
                            🤍 {{ $likeCount }} J'aime
                        </button>
                    @endauth
                ...
                <div style="padding-top:14px;border-top:1px solid #E2E8F0;">
                    ...
                    @auth
                        ...
                        @endif
                    @else
                        <button onclick="afficherAlerte()" style="font-size:13px;color:#1A9B5A;font-weight:600;background:transparent;border:none;cursor:pointer;">
            ...
            {{-- COMMENTAIRES --}}
            <div id="commentaires" style="background:#fff;border-radius:12px;border:1px solid #E2E8F0;padding:24px;">
                ...
                @else
                    <div style="background:#F4F6F9;border-radius:8px;padding:14px;margin-bottom:20px;text-align:center;font-size:13px;color:#5a6a7a;">
                        <button onclick="afficherAlerte()" style="color:#1A9B5A;font-weight:700;background:transparent;border:none;cursor:pointer;">Connectez-vous</button> pour laisser un commentaire.
                    </div>
                @endauth
    ...
    <div style="background:#fff;border-radius:14px;padding:28px;width:100%;max-width:440px;margin:20px;">
        ...
        <form method="POST" action="{{ route('signalement.store') }}">
            ...
            <div style="display:flex;gap:10px;">
                <button type="submit" style="flex:1;background:#c0392b;color:#fff;border:none;padding:12px;border-radius:8px;font-size:14px;font-weight:700;cursor:pointer;">
                    Envoyer
                </button>
